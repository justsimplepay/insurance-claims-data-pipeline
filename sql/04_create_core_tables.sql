...
ADD CONSTRAINT ck_core_customer_fsa
CHECK (fsa IS NULL OR fsa ~ '^[ABCEGHJ-NPRSTVXY][0-9][ABCEGHJ-NPRSTV-Z]ALTER TABLE core.customers DROP COLUMN IF EXISTS last_name;
